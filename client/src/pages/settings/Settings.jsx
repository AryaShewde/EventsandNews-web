...
const Settings = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (file) {
            ...
            try {
                await axios.post("https://eventsandnewsapi.onrender.com/api/upload", data);
            } catch (error) { }
        }
        try {
            const res = await axios.put('https://eventsandnewsapi.onrender.com/api/users/' + user._id, updatedUser);
            setSuccess(true);
